...
v0.new("<Color=Cyan>Welcome to Nam Hub<Color=/>"):Display();
wait(0.5);
...
v5.Window = function(v134, v135)
	...
	v170.Image = "http://www.roblox.com/asset/?id="   .. tostring(129327553005565) ;
...
v8.Image = "rbxassetid://129327553005565";
v8.Draggable = true;
...
game:GetService("StarterGui"):SetCore("SendNotification", {
	Title = "Đang mở",
	Text = "Loading...",
	Icon = "rbxthumb://type=Asset&id=129327553005565&w=150&h=150",
	Duration = 10
});
spawn(function()
	while wait() do
