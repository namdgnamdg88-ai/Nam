...
ImageButton.Name = "MenuToggleButton"
ImageButton.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
ImageButton.BackgroundTransparency = 0.3
ImageButton.BorderSizePixel = 0
ImageButton.Position = UDim2.new(0.85, 0, 0.02, 0)
ImageButton.Size = UDim2.new(0, 50, 0, 50)
ImageButton.Draggable = true
ImageButton.Image = "http://www.roblox.com/asset/?id=125824706340018"
...
ParticleEmitter.Lifetime = NumberRange.new(0.7, 1.2)
...
local rotateTween = TweenService:Create(ImageButton, 
    TweenInfo.new(0.5, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), 
    {Rotation = 360}
)

local scaleDownTween = TweenService:Create(ImageButton,
    TweenInfo.new(0.1, Enum.EasingStyle.Back, Enum.EasingDirection.Out),
    {Size = UDim2.new(0, 45, 0, 45)}
)

local scaleUpTween = TweenService:Create(ImageButton,
    TweenInfo.new(0.2, Enum.EasingStyle.Bounce, Enum.EasingDirection.Out),
    {Size = UDim2.new(0, 50, 0, 50)}
)

local function toggleMenuScript()
    ...
    if menuEnabled then
        ...
        ImageButton.BackgroundColor3 = Color3.fromRGB(170, 0, 0)
...
ImageButton.MouseButton1Click:Connect(toggleMenuScript)

local function updateTooltip()
    if menuEnabled then
        ImageButton.ToolTip = "Menu đang BẬT\nClick để tắt"
    else
        ImageButton.ToolTip = "Menu đang TẮT\nClick để bật"
    end
end

local originalToggle = toggleMenuScript
toggleMenuScript = function()
    originalToggle()
    updateTooltip()
end
...
ImageButton.MouseLeave:Connect(function()
    if not isToggling then
        local targetColor = menuEnabled and Color3.fromRGB(0, 255, 0) or Color3.fromRGB(255, 255, 255)
        TweenService:Create(ImageButton, TweenInfo.new(0.2), {
...
print("Menu Toggle Button Ready")
...
_G.toggleMenu = toggleMenuScript
_G.getMenuStatus = function()
    return menuEnabled
end